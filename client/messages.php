...
<body>
    ...
    <div class="dashboard-container">
        ...
        <main class="main-content">
            <div class="page-header"><h1>Messages</h1><p>Communicate with case managers and service providers</p></div>
            <div class="alert alert-info"><p><strong>Messaging feature coming soon!</strong></p><p>Send and receive secure messages with your case manager and service providers.</p></div>
        </main>
    </div>
