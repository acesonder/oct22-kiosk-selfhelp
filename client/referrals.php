...
<body>
    ...
    <div class="dashboard-container">
        ...
        <main class="main-content">
            <div class="page-header"><h1>My Referrals</h1><p>Track your referrals to service providers</p></div>
            <div class="alert alert-info"><p><strong>Referrals feature coming soon!</strong></p><p>View and track referrals to housing, food, healthcare, and other service providers.</p></div>
        </main>
    </div>
